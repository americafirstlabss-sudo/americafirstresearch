    ...
    <header className="sticky top-0 z-40 border-b border-[#13233a]/10 bg-[rgba(251,250,246,0.88)] backdrop-blur-xl">
      <div className="shell flex h-20 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button type="button" onClick={openCart} className="relative inline-flex h-12 w-12 items-center justify-center rounded-full border border-[#13233a]/12 bg-white/80 text-[#13233a]">
          ...
          <button type="button" onClick={() => setMobileOpen(true)} className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-[#13233a]/12 bg-white/80 text-[#13233a] lg:hidden">
            <Menu className="h-5 w-5" />
          </button>
        </div>
      </div>
      <div className="border-t border-[#13233a]/8 bg-[linear-gradient(90deg,rgba(111,136,184,0.08),rgba(146,32,48,0.06),rgba(156,122,43,0.08))] py-2 text-center text-[11px] uppercase tracking-[0.35em] text-[#13233a]/48">
      ...
      <Dialog.Root open={mobileOpen} onOpenChange={setMobileOpen}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed right-0 top-0 z-50 flex h-full w-full max-w-sm flex-col border-l border-[#13233a]/10 bg-[linear-gradient(180deg,#fbfaf6,#f2eee4)] p-6 lg:hidden">
